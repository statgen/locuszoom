...
describe('LocusZoom Core', function() {
    ...
    describe('LocusZoom Core', function() {
        ...
        describe('Update State Positions', function() {
            it('should have a _updateStatePosition function', function() {
                LocusZoom._updateStatePosition.should.be.a.Function;
            });
            it('should do nothing if passed a state with no predicted rules / structure', function() {
                var state = { foo: 'bar' };
                state = LocusZoom._updateStatePosition(state);
                state.foo.should.be.exactly('bar');
                var stateB = { start: 'foo', end: 'bar' };
                stateB = LocusZoom._updateStatePosition(stateB);
            ...
            it('should enforce no zeros for start and end (if present with chr)', function() {
                ...
                stateA = LocusZoom._updateStatePosition(stateA);
            ...
            it('should enforce no non-numeric values for start and end (if present with chr)', function() {
                ...
                stateC = LocusZoom._updateStatePosition(stateC);

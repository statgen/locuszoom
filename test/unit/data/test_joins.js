...
describe('Custom join operations', function () {
    describe('assoc_to_gwas_catalog', function () {
        before(function() {
            this.func = JOINS.get('assoc_to_gwas_catalog');
        });
        ...
        it('aligns records based on loose position match', function () {
            ...
            const res = func(assoc_data, catalog_data, 'assoc.position', 'catalog.pos', 'catalog.log_pvalue');
        ...
        it('gracefully handles no catalog entries in region', function () {
            ...
            const res = func(assoc_data, [], 'assoc.position', 'catalog.pos', 'catalog.log_pvalue');

...
import d3 from 'd3';
import {BaseClasses, DataLayers, Layouts} from 'locuszoom';
 ...
 */
const BaseLayer = DataLayers.get('BaseDataLayer');
class LzIntervalsTrack extends BaseLayer {
    constructor(layout) {
        Layouts.merge(layout, default_layout);
        super(...arguments);
        this.tracks = 1;
...
const intervals_panel_layout = {
    ...
    dashboard: (function () {
        const l = Layouts.get('dashboard', 'standard_panel', { unnamespaced: true });
        l.components.push({
...
const intervals_plot_layout = {
    ...
    dashboard: Layouts.get('dashboard', 'standard_plot', { unnamespaced: true }),
    panels: [
        ...
        Layouts.get('panel', 'genes', { unnamespaced: true, width: 800, proportional_height: (225 / 570) })
    ]
};
...
export const data_layers = [
    ['intervals', LzIntervalsTrack],
];

export const layouts = [
    ['tooltip', 'standard_intervals', intervals_tooltip_layout],
    ['data_layer', 'intervals', intervals_layer_layout],
    ['panel', 'intervals', intervals_panel_layout],
    ['plot', 'interval_association', intervals_plot_layout]
];

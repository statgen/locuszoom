...
class BaseDataLayer {
  ...
  Common reasons for this error include API payloads with missing fields, data layer layouts that use two kinds of data and need join logic in "data_operations", or joins that do not find matching records ("LD relative to unknown variant").                
